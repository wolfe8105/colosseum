...
function showPlaceholderModal(type: 'subscription' | 'tokens', detail: string): void {
  ...
  `;
  modal.innerHTML = `
    <div style="background:var(--mod-bg-card);border:1px solid var(--mod-accent-border);border-radius:12px;max-width:360px;width:100%;padding:24px;text-align:center;">
