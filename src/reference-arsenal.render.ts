 ...
 * renderArmory         — The Armory tab (search, chips, trending shelf, cards, bottom sheet)
 *
 * renderLibrary kept as backward compat alias.
 */
...
import type { ArsenalReference, TrendingReference, Rarity } from './reference-arsenal.types.ts';

const RARITY_SOCKET_COUNT: Record<Rarity, number> = {
