...
export function injectFeedFireworksCSS(): void {
  ...
  style.textContent = `
    ...
    .feed-fireworks::before { background:var(--mod-gold);box-shadow:12px -18px 0 var(--mod-side-a), -14px -12px 0 var(--mod-side-b), 20px 8px 0 var(--mod-gold), -18px 14px 0 var(--mod-side-a); }
    .feed-fireworks::after { background:var(--mod-side-b);box-shadow:-10px -20px 0 var(--mod-gold), 16px -10px 0 var(--mod-side-a), -20px 6px 0 var(--mod-side-b), 14px 16px 0 var(--mod-gold); }
