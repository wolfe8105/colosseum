...
export function injectFeedRoomCSS(): void {
  ...
  style.textContent = `
    ...
    .feed-side-a .feed-score-name { color:var(--mod-side-a); }
    .feed-side-b .feed-score-name { color:var(--mod-side-b); }
    ...
    .feed-timer.warning { color:var(--mod-side-a); animation:livePulse 0.8s ease-in-out infinite; }
