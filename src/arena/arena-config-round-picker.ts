// arena-config-round-picker.ts — Standalone round picker UI (zero arena-config deps)
// Extracted from arena-config-settings.ts to break the config-mode ↔ config-settings cycle.
