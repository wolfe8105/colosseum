...
export function injectFeedPhase4_5CSS(): void {
  ...
  style.textContent = `
    ...
    .feed-disconnect-banner {
      background:var(--mod-error); color:var(--mod-text-on-accent);text-align:center;padding:10px 16px;
    ...
    .feed-evt-disconnect {
      background:rgba(183,28,28,0.15);border-left:3px solid var(--mod-error);
      padding:8px 12px;margin:4px 0;border-radius:4px;
      color:var(--mod-error-light); font-size:13px;
    }
    ...
    .feed-mod-action-btn {
      background:transparent;border:1px solid rgba(183,28,28,0.5);color:var(--mod-error-light);
      font-size:11px;padding:4px 10px;border-radius:4px;cursor:pointer;
      text-transform:uppercase;letter-spacing:0.5px;
      transition:background 0.2s,border-color 0.2s;
    }
    .feed-mod-action-btn:hover { background:rgba(183,28,28,0.2);border-color:var(--mod-error); }
