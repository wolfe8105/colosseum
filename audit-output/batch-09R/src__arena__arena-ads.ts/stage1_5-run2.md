...
- `PUB_ID` (line 16): excluded — bound to a string literal, not a function definition.
- `SLOT_ID` (line 17): excluded — bound to a string literal, not a function definition.
