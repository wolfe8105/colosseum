...
window.ColosseumArena = (() => {
  ...
  window.addEventListener('popstate', (e) => {
    console.log('[DEBUG popstate] view:', view, 'skip:', _skipNextPop, 'state:', JSON.stringify(e.state));
    if (_skipNextPop) { _skipNextPop = false; console.log('[DEBUG popstate] SKIPPED'); return; }
    console.log('[DEBUG popstate] NOT SKIPPED — will act on view:', view);
  ...
  function renderLobby() {
    console.log('[DEBUG renderLobby] called from:', new Error().stack?.split('\n')[2]?.trim());
    view = 'lobby';
    selectedMode = null;
  ...
  function closeRankedPicker() {
    console.log('[DEBUG closeRankedPicker] called, view:', view);
  ...
  function closeModeSelect() {
    console.log('[DEBUG closeModeSelect] called, view:', view);
  ...
  function enterQueue(mode, topic) {
    console.log('[DEBUG enterQueue] mode:', mode, 'view:', view);
    selectedMode = mode;
    view = 'queue';
  ...
  async function showPreDebate(debateData) {
    console.log('[DEBUG showPreDebate] called, view:', view, 'debateId:', debateData.id);
  ...
  async function startAIDebate(topic) {
    console.log('[DEBUG startAIDebate] called, view:', view);
