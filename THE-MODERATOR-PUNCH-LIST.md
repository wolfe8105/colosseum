...
| F-55 | Reference System Overhaul | | ✅ Session 244 | Walked and locked S244, edited S246 for rarity rename + socket counts. Single canonical path (retire `submit_reference`). Dedup at forge time via canonical fingerprint (source_title + author + date + locator, hashed). No forks — first forger's claim_text stands. Escalating cite cost carries forward (1st free, 2nd 5, 3rd 15, 4th 35, 5th 50, hard cap 5/round). Rarity by composite score `(seconds × 2) + strikes`: Common 0-9, Uncommon 10-29, Rare 30-74, Legendary 75-199, Mythic 200+ AND graduated. Socket counts: Common 1, Uncommon 2, Rare 3, Legendary 4, Mythic 5 (feeds F-57). Graduation at 25 strikes. Challenge mechanic with graduated penalty (1st -5 seconds, 2nd more, 3rd auto-freeze). Loadout tiered by profile depth (3-10 slots). Full paragraph in pending spec file. |
