Run Full Monty audit Batch 56 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 56 only.
...
4. Audit directory is audit/batch56/ — create it if it does not exist.
   Manifest path: audit/batch56/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 56 file list.
...
Stop after Batch 56. Do not start the next batch.
