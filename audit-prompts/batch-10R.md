...
pre-filled for Batch 10R.

---

```
Run audit Batch 10R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 10R only. Ignore the other
   batches. The file list is under the "## Batch 10R" heading.
...
audit/manifest.batch9R.json, then create the fresh manifest
for Batch 10R.
...
Do not advance to the next batch on your own. Stop after Batch 10R
and wait.
```
