Run Full Monty audit Batch 43 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 43 only.
...
4. Audit directory is audit/batch43/ — create it if it does not exist.
   Manifest path: audit/batch43/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 43 file list.
...
Stop after Batch 43. Do not start the next batch.
