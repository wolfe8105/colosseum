Run Full Monty audit Batch 84 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 84 only.
...
4. Audit directory is audit/batch84/ — create it if it does not exist.
   Manifest path: audit/batch84/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 84 file list.
...
Stop after Batch 84. Do not start the next batch.
