...
pre-filled for Batch 15R.

---

```
Run audit Batch 15R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 15R only. Ignore the other
   batches. The file list is under the "## Batch 15R" heading.
...
audit/manifest.batch14R.json, then create the fresh manifest
for Batch 15R.
...
Do not advance to the next batch on your own. Stop after Batch 15R
and wait.
```
