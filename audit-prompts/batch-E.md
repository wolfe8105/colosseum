...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch E only. Ignore the other
   batches. The file list is under the "## Batch E" heading.
...
audit/manifest.batchPREV.json, then create the fresh manifest for Batch E.
...
Do not advance to the next batch on your own. Stop after Batch E and wait.
```
