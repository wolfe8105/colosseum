Run Full Monty audit Batch 49 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 49 only.
...
4. Audit directory is audit/batch49/ — create it if it does not exist.
   Manifest path: audit/batch49/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 49 file list.
...
Stop after Batch 49. Do not start the next batch.
