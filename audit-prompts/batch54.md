Run Full Monty audit Batch 54 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 54 only.
...
4. Audit directory is audit/batch54/ — create it if it does not exist.
   Manifest path: audit/batch54/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 54 file list.
...
Stop after Batch 54. Do not start the next batch.
