Run Full Monty audit Batch 81 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 81 only.
...
4. Audit directory is audit/batch81/ — create it if it does not exist.
   Manifest path: audit/batch81/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 81 file list.
...
Stop after Batch 81. Do not start the next batch.
