...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 52 only.
...
4. Audit directory is audit/batch52/ — create it if it does not exist.
   Manifest path: audit/batch52/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 52 file list.
...
Stop after Batch 52. Do not start the next batch.
