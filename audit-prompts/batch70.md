Run Full Monty audit Batch 70 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 70 only.
...
4. Audit directory is audit/batch70/ — create it if it does not exist.
   Manifest path: audit/batch70/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 70 file list.
...
Stop after Batch 70. Do not start the next batch.
