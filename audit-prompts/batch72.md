Run Full Monty audit Batch 72 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 72 only.
...
4. Audit directory is audit/batch72/ — create it if it does not exist.
   Manifest path: audit/batch72/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 72 file list.
...
Stop after Batch 72. Do not start the next batch.
