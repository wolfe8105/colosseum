...
pre-filled for Batch 14R.

---

```
Run audit Batch 14R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 14R only. Ignore the other
   batches. The file list is under the "## Batch 14R" heading.
...
audit/manifest.batch13R.json, then create the fresh manifest
for Batch 14R.
...
Do not advance to the next batch on your own. Stop after Batch 14R
and wait.
```
