...
pre-filled for Batch 9R.

---

```
Run audit Batch 9R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 9R only. Ignore the other
   batches. The file list is under the "## Batch 9R" heading.
...
audit/manifest.batch8Rc.json, then create the fresh manifest
for Batch 9R.
...
Do not advance to the next batch on your own. Stop after Batch 9R
and wait.
```
