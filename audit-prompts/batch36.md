Run Full Monty audit Batch 36 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 36 only.
...
4. Audit directory is audit/batch36/ — create it if it does not exist.
   Manifest path: audit/batch36/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 36 file list.
...
Stop after Batch 36. Do not start the next batch.
