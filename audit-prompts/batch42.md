Run Full Monty audit Batch 42 from THE MODERATOR repo.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 42 only.
...
4. Audit directory is audit/batch42/ — create it if it does not exist.
   Manifest path: audit/batch42/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 42 file list.
...
Stop after Batch 42. Do not start the next batch.
