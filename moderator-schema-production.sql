...
-- ========================
-- 10. DEBATES (LEGACY — ELIMINATED Session 101)
-- ========================
-- Legacy debates table has been consolidated into arena_debates.
-- Canonical schema is in colosseum-arena-schema.sql.
-- CREATE TABLE, indexes, and RLS policies removed.
-- See DEBATE-TABLE-CONSOLIDATION-PLAN.md for details.
