...
- **Token earn events:** daily login (+5 base, +1/streak day capped at +10), hot take (+3), reaction (+1), vote (+2), debate complete (+5/+10 win), AI sparring (+3), prediction (+2). All deduped via token_earn_log.
- **Token milestones (one-time):** first_hot_take (25), first_debate (50), first_vote (10), first_reaction (5), first_ai_sparring (15), first_prediction (10), profile_3_sections (30), profile_6_sections (75), profile_12_sections (150), verified_gladiator (100). Streak milestones award freezes: 7-day (+1), 30-day (+3), 100-day (+5).
- **Streak freeze:** miss exactly 1 day and a freeze auto-saves your streak. Earned at streak milestones. Stored in `streak_freezes` column on profiles.
- **Token gates:** 25 to post hot takes, 50 to challenge, 100 to predict.
...
| colosseum-async.js | Hot takes feed, predictions, rivals display, react toggle, challenge modal, prediction token earn |
...
| colosseum-arena.js | Arena: lobby, 4 modes, matchmaking, debate room, post-debate. AI sparring, moderator UX, ranked/casual. Token balance in lobby + room. |
| colosseum-tokens.js | Token earn system: daily login, action claims, milestones (13), streak freeze, gold coin animation, token gates, balance display |
...
| colosseum-profile-depth.html | 12 sections, 147 Qs, saves to DB via safeRpc, token milestone checks on section complete |
...
| colosseum-auto-debate.html | AI vs AI debate page, ungated voting, rage-click funnel, vote token earn. Auto-fetches latest debate on bare URL. |
...
- ⏳ Share card integration with token count
- ⏳ Token earn history page
