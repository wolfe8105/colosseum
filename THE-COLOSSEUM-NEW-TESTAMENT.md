...
12.3.21. ⏳ **Groq model decommissioned in Edge Functions** — ai-sparring + ai-moderator still reference llama-3.1-70b-versatile (dead). Bot army config updated to llama-3.3-70b-versatile but Edge Functions need redeployment via Supabase CLI on VPS. (Session 42)
