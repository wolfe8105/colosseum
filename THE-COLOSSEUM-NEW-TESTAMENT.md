...
### Last Updated: Session 49 (March 7, 2026) — Groups feature built + scenario audit reviewed
...
11.27.2. ⚠️ **Bug 11 (highest priority)** — profile_depth_answers never reach DB. localStorage only. RPC exists, table exists, wiring doesn't. Breaks ranked mode + entire B2B data play.
11.27.3. ⚠️ **Bug 2** — no auth prompt for guests on hot take react/post. Ghost interactions, zero conversion.
11.27.4. ⚠️ **Bug 3** — Plinko always redirects to index.html after signup. No returnTo parameter. Context lost.
