...
| ai-moderator | Groq Llama 3.1 70B evidence evaluator. Judges reference relevance to debate topic. Biases ALLOW, denies spam/trolling/off-topic. Falls back to auto-allow on error. temp 0.3. | ✅ Deployed Session 39 |
