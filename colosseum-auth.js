  ...
  function requireAuth(actionLabel) {
    ...
    modal.innerHTML = `
      <div style="background:#12122A;border:1px solid rgba(212,168,67,0.3);border-radius:12px;padding:28px 24px;max-width:340px;width:90%;text-align:center;">
        ...
        <div style="font-family:'Oswald',sans-serif;font-size:20px;font-weight:700;color:#D4A843;margin-bottom:8px;">JOIN THE ARENA</div>
        <div style="font-size:14px;color:#ccc;margin-bottom:20px;">Sign in to ${actionLabel || 'do that'}</div>
        <a href="colosseum-plinko.html?returnTo=${returnTo}" style="display:block;background:#D4A843;color:#0A0A1A;font-family:'Oswald',sans-serif;font-weight:700;font-size:16px;padding:12px;border-radius:8px;text-decoration:none;margin-bottom:10px;">SIGN UP FREE</a>
