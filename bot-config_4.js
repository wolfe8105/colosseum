...
// Updated Session 95: Bluesky config + flags wired in (was missing — LM-149).
// ============================================================
...
const config = {
  ...
  autoDebate: {
    ...
    // How many auto-debates per day max (Session 94: reduced from 6 to 3)
...
function validateConfig() {
  ...
  // Bluesky needs handle + app password
