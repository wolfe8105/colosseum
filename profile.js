...
const BASE_URL = 'https://colosseum-six.vercel.app';
...
function buildProfileHtml(profile) {
  ...
  const safeAvatarUrl = sanitizeAvatarUrl(p.avatar_url);
...
<div class="container">
  ...
  <div class="profile-header">
    <div class="avatar">${safeAvatarUrl ? `<img src="${escapeHtml(safeAvatarUrl)}" alt="${displayName}">` : initial}</div>
