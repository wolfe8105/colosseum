...
### Last Updated: Session 51 (March 8, 2026) — DRY_RUN=false, Bluesky go-live, postHotTake wiring bug fixed
...
12.2.22. ⏳ **Fix Bug 11** — Wire profile_depth_answers to Supabase. 5 lines in colosseum-profile-depth.html. Highest priority bug. Breaks ranked mode + B2B data play.
12.2.23. ⏳ **Fix Bug 2** — Auth prompts for guests on hot takes react/post. colosseum-async.js. Check ColosseumAuth.currentUser before RPC, redirect to Plinko if null.
12.2.24. ⏳ **Fix Bug 3** — returnTo parameter in Plinko. ~15 lines. Mirror CTAs need ?returnTo= param.
