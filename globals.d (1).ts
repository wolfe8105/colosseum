 ...
 *
 * Migration status:
 *   Phase 0 (infra): ✅ Session 125
 *   Phase 1 (config + auth): ✅ Session 126
 *   Phase 2 (tokens + defense): ✅ Session 126
 *   Phase 3 (all remaining modules): ✅ Session 127
 *   Phase 4 (HTML inline script extraction): ✅ Session 128
 *     10 page modules created in src/pages/
 *     10 HTML files updated (inline scripts → module script tags)
 *   Phase 5 (bot army): Future
 *   Phase 6 (tests + cleanup): Future
 */
...
interface ColosseumArenaGlobal {
  renderLobby: () => void;
  [key: string]: unknown; // Arena has many internal methods
}
