...
// - hot_takes.insert → rpc('create_hot_take')
// - hot_take_reactions.insert/delete → rpc('react_hot_take') (toggle)
// ============================================================
    ...
    if (ColosseumAuth?.supabase && !ColosseumAuth.isPlaceholderMode) {
      try {
        ...
        if (error) {
          ...
          // Update local take with real server ID
          newTake.id = data.id;
        }
      } catch (e) {
