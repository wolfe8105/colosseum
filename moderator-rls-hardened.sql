...
-- debates (legacy — removed Session 101, consolidated into arena_debates)
-- DROP POLICY IF EXISTS "Debates public read" ON debates;
-- DROP POLICY IF EXISTS "Authenticated users create debates" ON debates;
-- DROP POLICY IF EXISTS "Debaters update own debates" ON debates;
...
-- ---- DEBATES ----
-- Legacy debates_select_public removed (Session 101).
-- arena_debates already has arena_debates_select policy in colosseum-arena-schema.sql.
