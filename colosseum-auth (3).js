  ...
  function init() {
    ...
    try {
      ...
      supabase = window.supabase.createClient(
        ...
        {
          auth: {
            // SESSION 27: Bypass navigator.locks — prevents orphaned locks
            // from hanging every .rpc() call. Trade-off: no cross-tab auth
            // sync, which doesn't matter for a mobile-forward app.
