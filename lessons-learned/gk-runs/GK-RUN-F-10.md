# GATEKEEPER RUN — F-10 Power-Up Shop
...
Feature: F-10 — Power-Up Shop
Source file: src/pages/home.arsenal-shop.ts
Spec: First check docs/product/ for a dedicated spec file for F-10. If none, use docs/THE-MODERATOR-PUNCH-LIST.md row F-10.
...
git commit -m "test(gk): F-10 power-up shop — gk tests"
git push
