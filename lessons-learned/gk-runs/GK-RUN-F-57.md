# GATEKEEPER RUN — F-57 Modifier and Power-Up System
...
Feature: F-57 — Modifier and Power-Up System
Source file: src/pages/home.arsenal-shop.ts
Spec: First check docs/product/ for a dedicated spec file for F-57. If none, use docs/THE-MODERATOR-PUNCH-LIST.md row F-57.
...
FILE READ PROOF: For every file you read, state filename and exact line count before acting on it. Format: READ: src/pages/home.arsenal-shop.ts — N lines

STEP 0 — DEPENDENCY MAP
Read _archive/prototypes/colosseum-critical-path-v3.txt. If missing, query codebase directly.
Report:
MAP QUERY — src/pages/home.arsenal-shop.ts
...
Assert every import in src/pages/home.arsenal-shop.ts is on the allowed list from Step 2.

STEP 5 — RUN AND REPORT
npm test -- tests/gk-home-arsenal-shop.test.ts
Also run regression surface tests.

If PASS:
git add tests/gk-home-arsenal-shop.test.ts
git commit -m "test(gk): F-57 modifier power-up system — gk tests"
git push
