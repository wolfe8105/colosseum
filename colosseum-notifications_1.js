      ...
      return `
        ...
        ">
          ...
          <div style="flex:1;min-width:0;">
            <div style="font-weight:700;font-size:13px;color:#f0f0f0;margin-bottom:2px;">${esc(n.title)}</div>
            <div style="font-size:12px;color:#a0a8b8;line-height:1.4;">${esc(n.body)}</div>
