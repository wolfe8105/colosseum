...
pre-filled for Batch 13R.

---

```
Run audit Batch 13R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 13R only. Ignore the other
   batches. The file list is under the "## Batch 13R" heading.
...
audit/manifest.batch12R.json, then create the fresh manifest
for Batch 13R.
...
Do not advance to the next batch on your own. Stop after Batch 13R
and wait.
```
