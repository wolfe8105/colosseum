...
Then run Full Monty audit Batch 27.
...
2. Read FULL-MONTY-BATCH-PLAN.md and extract the file list for Batch 27 only.
...
4. Audit directory is audit/batch27/ — create it if it does not exist.
   Manifest path: audit/batch27/manifest.json
   Do NOT use audit/manifest.json (reserved for the legacy 16R run).
5. Follow the v3 orchestration prompt using the Batch 27 file list.
...
Stop after Batch 27. Do not start the next batch.
