...
pre-filled for Batch 12R.

---

```
Run audit Batch 12R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 12R only. Ignore the other
   batches. The file list is under the "## Batch 12R" heading.
...
audit/manifest.batch11R.json, then create the fresh manifest
for Batch 12R.
...
Do not advance to the next batch on your own. Stop after Batch 12R
and wait.
```
