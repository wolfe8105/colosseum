...
pre-filled for Batch 11R.

---

```
Run audit Batch 11R from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   The file list. For this run, use Batch 11R only. Ignore the other
   batches. The file list is under the "## Batch 11R" heading.
...
audit/manifest.batch10R.json, then create the fresh manifest
for Batch 11R.
...
Do not advance to the next batch on your own. Stop after Batch 11R
and wait.
```
