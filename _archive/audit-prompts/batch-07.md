...
pre-filled for Batch 7.

---

```
Run audit Batch 7 from THE MODERATOR repo.
...
2. FIRST-RUN-FILES.md
   ...
   use Batch 7 only. Ignore the other batches.
...
Each batch run gets its own manifest. Before starting Batch 7,
if an old manifest from Batch 6 (or earlier) is present at
...
Do not advance to Batch 8 on your own. Stop after Batch 7
and wait.
```
