...
Both arbiter runs agreed on the same 25 entries. No reconciliation required. No candidates excluded. SOUNDS, INTRO_SYNTHS (object literals) and INTRO_TRACKS (array literal) are not function definitions.
